# figure8: Composition-matched CellChat

cellchat_ECM_Fib_revision_allcell_original_style.R is the final all-cell ECM workflow. composition_corrected_cellchat.R provides repeated matched-cell sensitivity analysis. Original uncorrected workflows are not the primary figure.
