# figure2: Bulk preprocessing and differential expression

preprocessing/GEO数据处理、合并.R -> differential_expression/limma 分析+火山图绘制.R -> enrichment/GO_KEGG富集分析.R. Full discovery matrix contains 172 samples.
