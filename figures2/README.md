# figures2: Exploratory screening and model sensitivity

rerun_41gene.R -> plot_corrected_S2.R; see figure5 for fixed three-gene modeling. Read README_corrected_release.md for the historical permutation-ranking discrepancy.
