# figure9: Spatial transcriptomics

NC and PD folders preserve reading, annotation, RCTD, MISTy and spatial CellChat sources; final_gene_panels contains the revised three-gene maps. See figures7 for added PD sections. RCTD weights_full are continuous weights; spot-level tests are descriptive.
