...
import subprocess, io, shutil, json
from PIL import Image, ImageChops
from pypdf import PdfReader, PdfWriter, Transformation
from reportlab.pdfgen.canvas import Canvas

HERE=Path(__file__).resolve().parent
OLD=Path('G:/1Yunvjian/机器学习/8.10/结果/three_gene_Figure5_FigureS2_20260902')
FIG=Path('G:/1Yunvjian/1A玉女煎/Figure')
...
qa=[]
qa.append(assemble('Figure5_three_gene_corrected_20260902',[(320,[(f5[0],365),(f5[1],310),(f5[2],477)]),(320,[(f5[3],620),(f5[4],532)]),(320,[(f5[5],370),(f5[6],390),(f5[7],392)])],1152,960))
qa.append(assemble('FigureS2_three_gene_corrected_20260902',[(312,[('FigureS2_A_residual_boxplots',384),('FigureS2_B_residual_reverse_ECDF',384),('FigureS2_C_screening_ROC',384)]),(292,[('FigureS2_D_candidate_rankings',440),(e,712)]),(292,[('FigureS2_F_WGCNA_correlations',440),(g,712)])],1152,896))
