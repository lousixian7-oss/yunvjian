...
WGCNA.R -> enrichment scripts. WGCNA removes GSM261278 (171 samples), then selects 5,000 genes. The current caption uses nominal module–trait P values; the Bonferroni script is a sensitivity calculation.
