# figures8: Virtual AGT perturbation

AGT knockout and network-weight overexpression are separate exploratory workflows. These modify inferred networks, not measured gene expression in a biological experiment.
